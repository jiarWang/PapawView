 ...
 */
@RequiresApi(21)
class XRoundRectDrawable extends Drawable {
    ...
    XRoundRectDrawable(ColorStateList backgroundColor, float radius) {
        mRadius = radius;
    ...
    private void updateBounds(Rect bounds) {
        ...
        mBoundsI.set(bounds);
        if (mInsetForPadding) {
            float vInset = XRoundRectDrawableWithShadow.calculateVerticalPadding(mPadding, mRadius, mInsetForRadius);
            float hInset = XRoundRectDrawableWithShadow.calculateHorizontalPadding(mPadding, mRadius, mInsetForRadius);
